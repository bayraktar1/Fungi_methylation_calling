...
parser.add_argument('--chromosome_sizes', required=True, type=str,
                    help='Path to file with chromosomse sizes:chromosome size')
...
parser.add_argument('--score_calculation', required=True, type=str,
                    help='fraction_score, weighted_meth, fungi_weighted_meth')
...
def print_args():
    ...
    print(f'chromosome_sizes: {args.chromosome_sizes}')
    print(f'window_size: {args.window_size}')
    print(f'output: {args.output}')
    print(f'directory {args.directory}')
    print(f'score_calculation: {args.score_calculation}')
...
if __name__ == "__main__":
    ...
    final_output = output_dir / outfile
    feather.write_feather(final_df, final_output)
